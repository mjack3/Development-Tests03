...
<form:form action="bill/poller/confirmAdd.do" modelAttribute="bill">
	...
	<div class="form-group" style="width: 20%;">
		...
		<label> <spring:message code="bill.receipt" />
		</label> <br /> <input class="form-control" value="${bill.receipt}"
			type="text" name="receipt" id="receipt" />
			<jstl:if test="${error}">
				<label style="color: red;"> <spring:message code="bill.error" /> </label>
			</jstl:if>
		<br />
