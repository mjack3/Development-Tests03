...
public class BillServiceTest extends AbstractTest {
	...
	public void driverAddReceiptTest() {
		final Object testingData1[][] = {
			...
			{
				"poller1", "receipt", 200, null
			},
			//  Poller añade recibo a bill pagada
			{
				"poller1", "receipt", 201, ConstraintViolationException.class
			},
			//  administrador añade recibo a bill pagada
			{
				"admin", "receipt", 200, ConstraintViolationException.class
			}
		};
	...
	protected void AddReceiptTest(final String username, final String receipt, final Integer billId, final Class<?> expected) {
		// TODO Auto-generated method stub
		Class<?> caught;
	...
	public void driverEndorsedBill() {
		final Object testingData1[][] = {
			...
			{
				"poller1", 200, IllegalArgumentException.class
			}
		};
	...
	protected void EndorsedBillTest(final String username, final Integer billId, final Class<?> expected) {
		// TODO Auto-generated method stub
		Class<?> caught;
		...
		try {
			...
			this.authenticate(username);
			this.billService.endorse(this.billService.findOne(billId));
			;
			this.unauthenticate();
